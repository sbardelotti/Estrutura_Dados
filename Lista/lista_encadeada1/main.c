...
int main()
{
    ...
    Lista *l, *copia, *cat, *outra, *uniao, *inter, *par, *impar, *intercalada;
    int a;
    l = CriaLista();
    copia = CriaLista();
    outra = CriaLista();
    ...
    printf("\nLista outra: ");
    ImprimirLista(outra);
    printf("\nInvertendo lista outra: ");
    InverteLista(outra);
    ImprimirLista(outra);

    printf("\n");

    printf("\nLista com apenas os pares da lista outra: ");
    par = ListaPar(outra);
    ImprimirLista(par);
    printf("\nLista com apenas os impares da lista outra: ");
    impar = ListaImpar(outra);
    ImprimirLista(impar);
    printf("\nLista impar e par intercalada: ");
    intercalada = IntercalarLista(impar, par);
